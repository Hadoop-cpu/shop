...
public class BeanUtils {
 ...
 public static <T> List<T> toBeanList(List<Map<String, Object>> list, Class<T> clazz)
	...
	public static <T> T toBean(Map<String, Object> map, Class<T> clazz)
		...
		Set<String> keys = map.keySet();// 获取Map中keys,字段名
...
//		System.out.println("字段个数="+colNames.length);
...
//				System.out.println(colName);
				// 取首字符addressid，colName.substring(0, 1)：a-》A
				String newcolName = colName.substring(0, 1).toUpperCase();// 将首字符变成大写,a->A
				newcolName = newcolName + colName.substring(1);//Addressid
				methodName += newcolName;//setAdrressid
