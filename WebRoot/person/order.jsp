...
<body>
	...
	<div class="nav-table">
		...
		<div class="nav-cont">
			<ul>
				<li class="index"><a
					href="${pageContext.request.contextPath}/productServlet">首页</a></li>
									...
									<c:forEach var="orderitem" items="${orderlist }">
										...
										<div class="order-status5">
											<div class="order-title">
												<div class="dd-num">
													订单编号：<a href="javascript:;">${orderitem.orderid }</a>
												</div>
												<span>下单时间：<fmt:formatDate type="time" value="${orderitem.ordertime }" pattern="yyyy-MM-dd hh:mm:ss" />
												</span>
												<!--    <em>店铺：小桔灯</em>-->
											</div>
											<div class="order-content">
												<div class="order-left">
												<c:forEach var="item" items="${orderitem.orderItems }">
													<ul class="item-list">
														<li class="td td-item">
															<div class="item-pic">
													...
													<div class="move-right">
														<li class="td td-status">
															...
															<c:choose>
																...
																<p class="order-info">
																	<a href="${pageContext.request.contextPath}/orderServlet?action=findById&id=${orderitem.orderid}">订单详情</a>
																</p>
																<p class="order-info">
														...
														<li class="td td-change">
															<c:choose>
																<c:when test="${orderitem.status==0 }">
																	<a href="${pageContext.request.contextPath}/orderServlet?action=paying&id=${orderitem.orderid}">
