...
<body style="background:#f0f9fd;">
    ...
    <span><img src="images/leftico01.png" /></span>商品信息管理
    	...
    	<ul class="menuson">
        <li><cite></cite><a href="${pageContext.request.contextPath}/categoryManageServlet?action=findAllNo" target="rightFrame">发布商品</a><i></i></li>
        <li class="active"><cite></cite><a href="${pageContext.request.contextPath}/adminProductServlet?action=findAllPage" target="rightFrame">商品列表</a><i></i></li>
        </ul>    
    </dd>
    <dd>
    <div class="title">
    ...
    <ul class="menuson">
        ...
        <li><cite></cite><a href="${pageContext.request.contextPath}/categoryManageServlet?action=findAll" target="rightFrame">分类列表</a><i></i></li>
        </ul>     
    </dd> 
