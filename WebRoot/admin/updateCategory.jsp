...
<body>
	...
	<form action="<c:url value='/categoryManageServlet'/>" method="post" id="form1">
		...
		<div class="formbody">
			...
			<ul class="forminfo">
				<li><label>分类名称<b>*</b>
				</label><input name="name" value=${category.name } type="text" class="dfinput" style="width:278px;" onblur="validateName()"/>
				</li>
				<li><label>商品分类排序<b>*</b>
				</label>
					<div class="vocation">
						<input name="sort" value=${category.sort } type="text" class="dfinput" style="width:278px;" onblur="validateSort()"/>
					</div></li>
					<li><label id="result" style="width:278px;color:red" >${msg}</label>
				</li>
				<li><label >&nbsp;</label><input name="" type="button"
					class="btn" value="修改" onclick="validate()"/>
				</li>
			</ul>
