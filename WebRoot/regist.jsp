...
<link href="<c:url value='/css/dlstyle.css'/>" rel="stylesheet" type="text/css">
				...
				<div class="am-tabs" id="doc-my-tabs">
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-active">
							<form method="post" id="form1" action="${pageContext.request.contextPath}/userServlet">
								...
								<div class="user-pass">
									...
									</label> <input type="password" name="password1" id="password"
										placeholder="设置密码">
								</div>
								<div class="user-pass">
